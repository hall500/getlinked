    ...
    return (
        <Wrapper>
            <div className="wrapper">
                ...
                <h1>getlinked Tech Hackathon <span>1.0</span> <img src="/images/link-img.png" alt="link-logo" /> <img src="/images/explode.png" alt="explode" /></h1>
...
width: 100%;
height: auto;
background: url('/images/multiple.png'), #140D27 -155.25px -155px / 114.411% 118.9% no-repeat;
